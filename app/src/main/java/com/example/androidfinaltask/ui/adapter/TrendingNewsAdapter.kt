...
import com.example.androidfinaltask.databinding.ItemTrendingNewsBinding

class TrendingNewsAdapter(
    private val onItemClick: (Article) -> Unit
) : ListAdapter<Article, TrendingNewsAdapter.ViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemTrendingNewsBinding.inflate(
